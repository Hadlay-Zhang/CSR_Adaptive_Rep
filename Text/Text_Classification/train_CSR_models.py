...
parser.add_argument('--embed_dim', default=4096, type=int, help='timm model name')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.hidden_size is None:
        args.hidden_size = args.embed_dim * 4
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.rank == 0:
            file_name = f'{args.task_name}_CSR_topk_{args.topk}'
